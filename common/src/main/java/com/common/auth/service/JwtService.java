...
import com.common.auth.props.JwtPorps;
...
@EnableConfigurationProperties(JwtPorps.class)
public class JwtService {
    @Autowired
    private final UserDetailsService userDetailsService;

    private final JwtPorps jwtPorps;
...
//    private String REFRESH_TOKEN;
    ...
    public String generateAccessToken(String userId, String login, List<String> roles) {
        return Jwts.builder()
                ...
                .signWith(getSignInKey(jwtPorps.getAccessSecret()), SignatureAlgorithm.HS256)
                .compact();
    }
    ...
    public String generateRefreshToken(String userId, String login) {
        return Jwts.builder()
                ...
                .setIssuedAt(new Date(System.currentTimeMillis()))
                .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * 24)) // 1 day
                .signWith(getSignInKey(jwtPorps.getRefreshSecret()), SignatureAlgorithm.HS256)
                .compact();
    }

    private Claims extractAllClaimsFromAccess(String token, boolean isAccess) {
        return Jwts.parser().
                setSigningKey(getSignInKey(isAccess ? jwtPorps.getAccessSecret() : jwtPorps.getRefreshSecret()))
